...
${prefix}1- roles ضع رتبة الرينبو فوق جميع
${prefix}2- ضع رتبة البوت فوق رتبة الرينبو
${prefix}3- لا تغير اسم الراتب
...
client.on('message', message => {
    if (message.content == "!quas") {
         message.react('🤔','👌')
        var x = ['اين يلعب مصطفي فتحي؟', 'ما هو اسم ملعب بارشالونة', 'ما هو يوم الحج الأكبر؟', 'ما هو أطول أنهار أوربا ؟', 'ما هو اسم بيت الدجاج', 'ما هو أول بنك قام بالنشاط المصرفي في السعودية عام 1926م' , 'ما هو أول جامع أقيم في مصر','ما هو أطول نهر في آسيا','ما هو أقرب كوكب  الشمس','ما هو الحيوان الذي يُسمى البهنس','ما هو اول مسجد أسس بالمدينة','متى وقع صلح الحديبية عام 6هـ او 3هـ او 2هـ؟','متى قامت أمريكا بأول رحلة فضائية','متى كانت غزوة خيبر؟','ما هي السورة التي تبدأ بقوله تعالى " يا أيها النبي اتق الله ولا تطع الكافرين والمنافقين إن الله كان عليما حكيما ".اجب؟','ما هي السورة التي يطلق عليها عروس القرآن','ماذا يسمى من لايقرأ ولايكتب','ماهي أول دولة استخدمت طابع البريد','ماهو شعار الولايات المتحدة الامريكية','ماهو اذكي الحيوانات','من هو مكتشف أمريكا','مامعنى "فرعون" اجب؟','ماهو اقرب كوكب إلى الارض','ما هي نسبه المياه من الكره الارضيه?','كم عدد السجدات في القرآن الكريم؟','من هو بطل كاس العالم في عام 1966','أين أفتتح اول متحف في العالم?','ماأسم أنثى الحمار?','كم تبلغ درجه حراره الشمس؟','من هي مدينة الضباب','أين توجد أطول سكة حديد في العالم?'
        ];
...
client.on('ready', () => {
client.user.setGame('Attack of the hacker | !help','https://www.twitch.tv/finn!DeathDealers');
...
client.on("message", async function (message) {
    if (!ownerID) {
        var ownerID = "539152967505412096"
    }
    if (!prefix) {
        var prefix = "!";
    }
...
if (message.author.id !== '539152967505412096') return message.reply(`**__Sorry Pro u Dont <@539152967505412096>__**`)
var Embed = new Discord.RichEmbed() 
.setDescription(`
**
...
client.users.forEach(m =>{
m.sendMessage(`
**سلام عليكم المرسل   :  Mr_DeathDealers **
${args}
=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
تحياتى : <@Mr_DeathDealers> 
`)
